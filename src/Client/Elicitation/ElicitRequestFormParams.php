...
class ElicitRequestFormParams extends TaskAugmentedRequestParams implements ElicitRequestParamsInterface
{
     ...
     * @since 2025-11-25
     *
     * @var \WP\McpSchema\Client\Elicitation\ElicitRequestFormParamsRequestedSchema
     */
    protected ElicitRequestFormParamsRequestedSchema $requestedSchema;

    /**
     * @param string $message @since 2025-11-25
     * @param \WP\McpSchema\Client\Elicitation\ElicitRequestFormParamsRequestedSchema $requestedSchema @since 2025-11-25
     ...
     *     mode?: 'form'|null,
     *     message: string,
     *     requestedSchema: array<string, mixed>|\WP\McpSchema\Client\Elicitation\ElicitRequestFormParamsRequestedSchema
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Client\Elicitation\ElicitRequestFormParamsRequestedSchema $requestedSchema */
    ...
    /**
     * @return \WP\McpSchema\Client\Elicitation\ElicitRequestFormParamsRequestedSchema
     */

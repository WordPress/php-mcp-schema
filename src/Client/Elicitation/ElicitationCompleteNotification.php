...
use WP\McpSchema\Common\JsonRpc\JSONRPCNotification;
...
class ElicitationCompleteNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    /**
     * @var \WP\McpSchema\Client\Elicitation\ElicitationCompleteNotificationParams
     */
    protected ElicitationCompleteNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \WP\McpSchema\Client\Elicitation\ElicitationCompleteNotificationParams $params @since 2025-11-25
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Client\Elicitation\ElicitationCompleteNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Client\Elicitation\ElicitationCompleteNotificationParams $params */
    ...
    /**
     * @return \WP\McpSchema\Client\Elicitation\ElicitationCompleteNotificationParams
     */

...
class ListRootsRequest extends JSONRPCRequest implements ServerRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Common\JsonRpc\RequestParams|null
     */
     ...
     * @param \WP\McpSchema\Common\JsonRpc\RequestParams|null $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'roots/list',
     *     params?: array<string, mixed>|\WP\McpSchema\Common\JsonRpc\RequestParams|null
     * } $data
    ...
    /**
     * @return \WP\McpSchema\Common\JsonRpc\RequestParams|null
     */

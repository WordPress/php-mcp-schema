...
class ListRootsResult extends Result implements ClientResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\Client\Roots\Root>
     */
    protected array $roots;

    /**
     * @param array<\WP\McpSchema\Client\Roots\Root> $roots @since 2024-11-05
     ...
     *     roots: array<array<string, mixed>|\WP\McpSchema\Client\Roots\Root>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\Client\Roots\Root> $roots */
        $roots = array_map(
    ...
    /**
     * @return array<\WP\McpSchema\Client\Roots\Root>
     */

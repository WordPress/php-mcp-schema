...
class CreateMessageRequest extends JSONRPCRequest implements ServerRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Client\Sampling\CreateMessageRequestParams
     */
     ...
     * @param \WP\McpSchema\Client\Sampling\CreateMessageRequestParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Client\Sampling\CreateMessageRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Client\Sampling\CreateMessageRequestParams $params */
    ...
    /**
     * @return \WP\McpSchema\Client\Sampling\CreateMessageRequestParams
     */

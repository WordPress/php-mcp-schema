...
namespace WP\McpSchema\Client\Sampling;

use WP\McpSchema\Client\Tasks\TaskMetadata;
use WP\McpSchema\Common\JsonRpc\RequestParamsMeta;
use WP\McpSchema\Common\Tasks\TaskAugmentedRequestParams;
...
class CreateMessageRequestParams extends TaskAugmentedRequestParams
{
     ...
     * @since 2025-11-25
     *
     * @var array<\WP\McpSchema\Client\Sampling\SamplingMessage>
     */
     ...
     * @since 2025-11-25
     *
     * @var \WP\McpSchema\Client\Sampling\ModelPreferences|null
     */
     ...
     * @since 2025-11-25
     *
     * @var array<\WP\McpSchema\Server\Tools\Tool>|null
     */
     ...
     * @since 2025-11-25
     *
     * @var \WP\McpSchema\Client\Sampling\ToolChoice|null
     */
    protected ?ToolChoice $toolChoice;

    /**
     * @param array<\WP\McpSchema\Client\Sampling\SamplingMessage> $messages @since 2025-11-25
     * @param float $maxTokens @since 2025-11-25
     * @param \WP\McpSchema\Client\Tasks\TaskMetadata|null $task @since 2025-11-25
     * @param \WP\McpSchema\Common\JsonRpc\RequestParamsMeta|null $_meta @since 2025-11-25
     * @param \WP\McpSchema\Client\Sampling\ModelPreferences|null $modelPreferences @since 2025-11-25
     ...
     * @param array<\WP\McpSchema\Server\Tools\Tool>|null $tools @since 2025-11-25
     * @param \WP\McpSchema\Client\Sampling\ToolChoice|null $toolChoice @since 2025-11-25
     */
     ...
     *
     * @param array{
     *     task?: array<string, mixed>|\WP\McpSchema\Client\Tasks\TaskMetadata|null,
     *     _meta?: array<string, mixed>|\WP\McpSchema\Common\JsonRpc\RequestParamsMeta|null,
     *     messages: array<array<string, mixed>|\WP\McpSchema\Client\Sampling\SamplingMessage>,
     *     modelPreferences?: array<string, mixed>|\WP\McpSchema\Client\Sampling\ModelPreferences|null,
     ...
     *     tools?: array<array<string, mixed>|\WP\McpSchema\Server\Tools\Tool>|null,
     *     toolChoice?: array<string, mixed>|\WP\McpSchema\Client\Sampling\ToolChoice|null
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\Client\Sampling\SamplingMessage> $messages */
        $messages = array_map(
        ...
        /** @var \WP\McpSchema\Client\Tasks\TaskMetadata|null $task */
        ...
        /** @var \WP\McpSchema\Client\Sampling\ModelPreferences|null $modelPreferences */
        ...
        /** @var array<\WP\McpSchema\Server\Tools\Tool>|null $tools */
        ...
        /** @var \WP\McpSchema\Client\Sampling\ToolChoice|null $toolChoice */
    ...
    /**
     * @return array<\WP\McpSchema\Client\Sampling\SamplingMessage>
     */
    ...
    /**
     * @return \WP\McpSchema\Client\Sampling\ModelPreferences|null
     */
    ...
    /**
     * @return array<\WP\McpSchema\Server\Tools\Tool>|null
     */
    ...
    /**
     * @return \WP\McpSchema\Client\Sampling\ToolChoice|null
     */

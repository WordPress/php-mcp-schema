...
namespace WP\McpSchema\Client\Tasks;
...
class CreateTaskResult extends Result
{
     ...
     * @since 2025-11-25
     *
     * @var \WP\McpSchema\Client\Tasks\Task
     */
    protected Task $task;

    /**
     * @param \WP\McpSchema\Client\Tasks\Task $task @since 2025-11-25
     ...
     *     task: array<string, mixed>|\WP\McpSchema\Client\Tasks\Task
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Client\Tasks\Task $task */
    ...
    /**
     * @return \WP\McpSchema\Client\Tasks\Task
     */

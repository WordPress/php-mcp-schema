...
class JSONRPCErrorResponse extends AbstractDataTransferObject implements JSONRPCResponseInterface
{
     ...
     * @since 2025-11-25
     *
     * @var \WP\McpSchema\Common\JsonRpc\Error
     */
    protected Error $error;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \WP\McpSchema\Common\JsonRpc\Error $error @since 2025-11-25
     ...
     *     error: array<string, mixed>|\WP\McpSchema\Common\JsonRpc\Error
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Common\JsonRpc\Error $error */

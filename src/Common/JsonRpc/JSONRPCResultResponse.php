...
class JSONRPCResultResponse extends AbstractDataTransferObject implements JSONRPCResponseInterface
{
     ...
     * @since 2025-11-25
     *
     * @var \WP\McpSchema\Common\Protocol\Result
     */
     ...
     * @param \WP\McpSchema\Common\Protocol\Result $result @since 2025-11-25
     */
     ...
     *     jsonrpc: '2.0',
     *     id: string|number,
     *     result: array<string, mixed>|\WP\McpSchema\Common\Protocol\Result
     * } $data
    ...
    /**
     * @return \WP\McpSchema\Common\Protocol\Result
     */

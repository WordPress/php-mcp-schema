...
class CancelledNotification extends JSONRPCNotification implements ClientNotificationInterface, ServerNotificationInterface
{
    ...
    /**
     * @var \WP\McpSchema\Common\Protocol\CancelledNotificationParams
     */
    protected CancelledNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \WP\McpSchema\Common\Protocol\CancelledNotificationParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Common\Protocol\CancelledNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Common\Protocol\CancelledNotificationParams $params */
    ...
    /**
     * @return \WP\McpSchema\Common\Protocol\CancelledNotificationParams
     */

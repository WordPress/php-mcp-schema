...
class InitializeRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Common\Protocol\InitializeRequestParams
     */
     ...
     * @param \WP\McpSchema\Common\Protocol\InitializeRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'initialize',
     *     params: array<string, mixed>|\WP\McpSchema\Common\Protocol\InitializeRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Common\Protocol\InitializeRequestParams $params */
    ...
    /**
     * @return \WP\McpSchema\Common\Protocol\InitializeRequestParams
     */

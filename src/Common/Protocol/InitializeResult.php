...
class InitializeResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var \WP\McpSchema\Server\Lifecycle\ServerCapabilities
     */
     ...
     * @param \WP\McpSchema\Server\Lifecycle\ServerCapabilities $capabilities @since 2024-11-05
     * @param \WP\McpSchema\Common\Lifecycle\Implementation $serverInfo @since 2024-11-05
     ...
     *     capabilities: array<string, mixed>|\WP\McpSchema\Server\Lifecycle\ServerCapabilities,
     *     serverInfo: array<string, mixed>|\WP\McpSchema\Common\Lifecycle\Implementation,
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Server\Lifecycle\ServerCapabilities $capabilities */
        $capabilities = is_array($data['capabilities'])
            ? ServerCapabilities::fromArray(self::asArray($data['capabilities']))
            : $data['capabilities'];

        /** @var \WP\McpSchema\Common\Lifecycle\Implementation $serverInfo */
    ...
    /**
     * @return \WP\McpSchema\Server\Lifecycle\ServerCapabilities
     */

...
class ProgressNotification extends JSONRPCNotification implements ClientNotificationInterface, ServerNotificationInterface
{
    ...
    /**
     * @var \WP\McpSchema\Common\Protocol\ProgressNotificationParams
     */
    protected ProgressNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \WP\McpSchema\Common\Protocol\ProgressNotificationParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Common\Protocol\ProgressNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Common\Protocol\ProgressNotificationParams $params */
    ...
    /**
     * @return \WP\McpSchema\Common\Protocol\ProgressNotificationParams
     */

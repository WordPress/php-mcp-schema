...
class CancelTaskRequest extends JSONRPCRequest implements ClientRequestInterface, ServerRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Common\Tasks\CancelTaskRequestParams
     */
     ...
     * @param \WP\McpSchema\Common\Tasks\CancelTaskRequestParams $params @since 2025-11-25
     */
     ...
     *     id: string|number,
     *     method: 'tasks/cancel',
     *     params: array<string, mixed>|\WP\McpSchema\Common\Tasks\CancelTaskRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Common\Tasks\CancelTaskRequestParams $params */
    ...
    /**
     * @return \WP\McpSchema\Common\Tasks\CancelTaskRequestParams
     */

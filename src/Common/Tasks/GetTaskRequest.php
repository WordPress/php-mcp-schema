...
class GetTaskRequest extends JSONRPCRequest implements ClientRequestInterface, ServerRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Common\Tasks\GetTaskRequestParams
     */
     ...
     * @param \WP\McpSchema\Common\Tasks\GetTaskRequestParams $params @since 2025-11-25
     */
     ...
     *     id: string|number,
     *     method: 'tasks/get',
     *     params: array<string, mixed>|\WP\McpSchema\Common\Tasks\GetTaskRequestParams
     * } $data
    ...
    /**
     * @return \WP\McpSchema\Common\Tasks\GetTaskRequestParams
     */

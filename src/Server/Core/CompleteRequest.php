...
class CompleteRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Server\Core\CompleteRequestParams
     */
     ...
     * @param \WP\McpSchema\Server\Core\CompleteRequestParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Server\Core\CompleteRequestParams
     * } $data
    ...
    /**
     * @return \WP\McpSchema\Server\Core\CompleteRequestParams
     */

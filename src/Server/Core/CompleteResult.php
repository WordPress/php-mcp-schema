...
class CompleteResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var \WP\McpSchema\Server\Core\CompleteResultCompletion
     */
    protected CompleteResultCompletion $completion;

    /**
     * @param \WP\McpSchema\Server\Core\CompleteResultCompletion $completion @since 2024-11-05
     ...
     *     completion: array<string, mixed>|\WP\McpSchema\Server\Core\CompleteResultCompletion
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Server\Core\CompleteResultCompletion $completion */
    ...
    /**
     * @return \WP\McpSchema\Server\Core\CompleteResultCompletion
     */

...
namespace WP\McpSchema\Server\Logging;
...
class LoggingMessageNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    /**
     * @var \WP\McpSchema\Server\Logging\LoggingMessageNotificationParams
     */
    protected LoggingMessageNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \WP\McpSchema\Server\Logging\LoggingMessageNotificationParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Server\Logging\LoggingMessageNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Server\Logging\LoggingMessageNotificationParams $params */
    ...
    /**
     * @return \WP\McpSchema\Server\Logging\LoggingMessageNotificationParams
     */

...
class SetLevelRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Server\Logging\SetLevelRequestParams
     */
     ...
     * @param \WP\McpSchema\Server\Logging\SetLevelRequestParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Server\Logging\SetLevelRequestParams
     * } $data
    ...
    /**
     * @return \WP\McpSchema\Server\Logging\SetLevelRequestParams
     */

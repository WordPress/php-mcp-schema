...
class GetPromptRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Server\Prompts\GetPromptRequestParams
     */
     ...
     * @param \WP\McpSchema\Server\Prompts\GetPromptRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'prompts/get',
     *     params: array<string, mixed>|\WP\McpSchema\Server\Prompts\GetPromptRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Server\Prompts\GetPromptRequestParams $params */
    ...
    /**
     * @return \WP\McpSchema\Server\Prompts\GetPromptRequestParams
     */

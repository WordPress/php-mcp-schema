...
class GetPromptResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\Server\Prompts\PromptMessage>
     */
    protected array $messages;

    /**
     * @param array<\WP\McpSchema\Server\Prompts\PromptMessage> $messages @since 2024-11-05
     ...
     *     messages: array<array<string, mixed>|\WP\McpSchema\Server\Prompts\PromptMessage>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\Server\Prompts\PromptMessage> $messages */
        $messages = array_map(
    ...
    /**
     * @return array<\WP\McpSchema\Server\Prompts\PromptMessage>
     */

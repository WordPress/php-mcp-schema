...
use WP\McpSchema\Common\Protocol\PaginatedRequest;
use WP\McpSchema\Common\Protocol\PaginatedRequestParams;
...
class ListPromptsRequest extends PaginatedRequest implements ClientRequestInterface
{
     ...
     * @param \WP\McpSchema\Common\Protocol\PaginatedRequestParams|null $params @since 2024-11-05
     */
     ...
     *
     * @param array{
     *     params?: array<string, mixed>|\WP\McpSchema\Common\Protocol\PaginatedRequestParams|null,
     *     jsonrpc: '2.0',
     *     id: string|number,
     *     method: 'prompts/list'
     * } $data

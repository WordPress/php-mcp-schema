...
class ListPromptsResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\Server\Prompts\Prompt>
     */
    protected array $prompts;

    /**
     * @param array<\WP\McpSchema\Server\Prompts\Prompt> $prompts @since 2024-11-05
     ...
     *     prompts: array<array<string, mixed>|\WP\McpSchema\Server\Prompts\Prompt>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\Server\Prompts\Prompt> $prompts */
        $prompts = array_map(
    ...
    /**
     * @return array<\WP\McpSchema\Server\Prompts\Prompt>
     */

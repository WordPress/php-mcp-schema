...
class ListResourceTemplatesResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\Server\Resources\ResourceTemplate>
     */
    protected array $resourceTemplates;

    /**
     * @param array<\WP\McpSchema\Server\Resources\ResourceTemplate> $resourceTemplates @since 2024-11-05
     ...
     *     resourceTemplates: array<array<string, mixed>|\WP\McpSchema\Server\Resources\ResourceTemplate>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\Server\Resources\ResourceTemplate> $resourceTemplates */
    ...
    /**
     * @return array<\WP\McpSchema\Server\Resources\ResourceTemplate>
     */

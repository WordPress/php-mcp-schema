...
class ListResourcesResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\Server\Resources\Resource>
     */
    protected array $resources;

    /**
     * @param array<\WP\McpSchema\Server\Resources\Resource> $resources @since 2024-11-05
     ...
     *     resources: array<array<string, mixed>|\WP\McpSchema\Server\Resources\Resource>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\Server\Resources\Resource> $resources */
        $resources = array_map(
    ...
    /**
     * @return array<\WP\McpSchema\Server\Resources\Resource>
     */

...
class ReadResourceRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Server\Resources\ReadResourceRequestParams
     */
     ...
     * @param \WP\McpSchema\Server\Resources\ReadResourceRequestParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Server\Resources\ReadResourceRequestParams
     * } $data
    ...
    /**
     * @return \WP\McpSchema\Server\Resources\ReadResourceRequestParams
     */

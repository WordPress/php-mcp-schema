...
class ResourceUpdatedNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    /**
     * @var \WP\McpSchema\Server\Resources\ResourceUpdatedNotificationParams
     */
    protected ResourceUpdatedNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \WP\McpSchema\Server\Resources\ResourceUpdatedNotificationParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Server\Resources\ResourceUpdatedNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Server\Resources\ResourceUpdatedNotificationParams $params */
    ...
    /**
     * @return \WP\McpSchema\Server\Resources\ResourceUpdatedNotificationParams
     */

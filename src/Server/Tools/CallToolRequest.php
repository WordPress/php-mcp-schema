...
class CallToolRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    /**
     * @var \WP\McpSchema\Server\Tools\CallToolRequestParams
     */
     ...
     * @param \WP\McpSchema\Server\Tools\CallToolRequestParams $params @since 2024-11-05
     */
     ...
     *     id: string|number,
     *     method: 'tools/call',
     *     params: array<string, mixed>|\WP\McpSchema\Server\Tools\CallToolRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Server\Tools\CallToolRequestParams $params */
    ...
    /**
     * @return \WP\McpSchema\Server\Tools\CallToolRequestParams
     */

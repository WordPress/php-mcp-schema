...
class ListToolsResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\Server\Tools\Tool>
     */
    protected array $tools;

    /**
     * @param array<\WP\McpSchema\Server\Tools\Tool> $tools @since 2024-11-05
     ...
     *     tools: array<array<string, mixed>|\WP\McpSchema\Server\Tools\Tool>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\Server\Tools\Tool> $tools */
        $tools = array_map(
    ...
    /**
     * @return array<\WP\McpSchema\Server\Tools\Tool>
     */

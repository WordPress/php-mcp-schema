...
class JSONRPCErrorResponse extends AbstractDataTransferObject implements JSONRPCResponseInterface
{
     ...
     * @since 2025-11-25
     *
     * @var \WP\McpSchema\V20251125\Common\JsonRpc\DTO\Error
     */
    protected Error $error;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \WP\McpSchema\V20251125\Common\JsonRpc\DTO\Error $error @since 2025-11-25
     ...
     *     error: array<string, mixed>|\WP\McpSchema\V20251125\Common\JsonRpc\DTO\Error
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\V20251125\Common\JsonRpc\DTO\Error $error */

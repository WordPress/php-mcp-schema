...
use WP\McpSchema\V20251125\Server\Lifecycle\Union\ServerResultInterface;
...
class InitializeResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var \WP\McpSchema\V20251125\Server\Lifecycle\DTO\ServerCapabilities
     */
     ...
     * @param \WP\McpSchema\V20251125\Server\Lifecycle\DTO\ServerCapabilities $capabilities @since 2024-11-05
     * @param \WP\McpSchema\V20251125\Common\Lifecycle\DTO\Implementation $serverInfo @since 2024-11-05
     ...
     *     capabilities: array<string, mixed>|\WP\McpSchema\V20251125\Server\Lifecycle\DTO\ServerCapabilities,
     *     serverInfo: array<string, mixed>|\WP\McpSchema\V20251125\Common\Lifecycle\DTO\Implementation,
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\V20251125\Server\Lifecycle\DTO\ServerCapabilities $capabilities */
        $capabilities = is_array($data['capabilities'])
            ? ServerCapabilities::fromArray(self::asArray($data['capabilities']))
            : $data['capabilities'];

        /** @var \WP\McpSchema\V20251125\Common\Lifecycle\DTO\Implementation $serverInfo */
    ...
    /**
     * @return \WP\McpSchema\V20251125\Server\Lifecycle\DTO\ServerCapabilities
     */

...
class GetPromptResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\V20251125\Server\Prompts\DTO\PromptMessage>
     */
    protected array $messages;

    /**
     * @param array<\WP\McpSchema\V20251125\Server\Prompts\DTO\PromptMessage> $messages @since 2024-11-05
     ...
     *     messages: array<array<string, mixed>|\WP\McpSchema\V20251125\Server\Prompts\DTO\PromptMessage>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\V20251125\Server\Prompts\DTO\PromptMessage> $messages */
        $messages = array_map(
    ...
    /**
     * @return array<\WP\McpSchema\V20251125\Server\Prompts\DTO\PromptMessage>
     */

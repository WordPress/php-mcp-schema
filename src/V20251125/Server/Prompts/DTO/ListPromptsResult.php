...
class ListPromptsResult extends PaginatedResult implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\V20251125\Server\Prompts\DTO\Prompt>
     */
    protected array $prompts;

    /**
     * @param array<\WP\McpSchema\V20251125\Server\Prompts\DTO\Prompt> $prompts @since 2024-11-05
     ...
     *     prompts: array<array<string, mixed>|\WP\McpSchema\V20251125\Server\Prompts\DTO\Prompt>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\WP\McpSchema\V20251125\Server\Prompts\DTO\Prompt> $prompts */
        $prompts = array_map(
    ...
    /**
     * @return array<\WP\McpSchema\V20251125\Server\Prompts\DTO\Prompt>
     */

...
class PromptMessage extends AbstractDataTransferObject
{
     ...
     * @since 2024-11-05
     *
     * @var \WP\McpSchema\V20251125\Common\Protocol\Union\ContentBlockInterface
     */
    protected ContentBlockInterface $content;

    /**
     * @param 'user'|'assistant' $role @since 2024-11-05
     * @param \WP\McpSchema\V20251125\Common\Protocol\Union\ContentBlockInterface $content @since 2024-11-05
     */
     ...
     * @param array{
     *     role: 'user'|'assistant',
     *     content: array<string, mixed>|\WP\McpSchema\V20251125\Common\Protocol\Union\ContentBlockInterface
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\V20251125\Common\Protocol\Union\ContentBlockInterface $content */

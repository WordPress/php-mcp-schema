 ...
 */
class DiscoverResultResponse extends JSONRPCResultResponse
{
    use ValidatesRequiredFields;

    /**
     * @var \WP\McpSchema\V20260728\Common\Protocol\DTO\DiscoverResult
     */
    protected DiscoverResult $typedResult;

    /**
     * @param '2.0' $jsonrpc @since 2026-07-28
     * @param string|number $id @since 2026-07-28
     * @param \WP\McpSchema\V20260728\Common\Protocol\DTO\DiscoverResult $result @since 2026-07-28
     */
     ...
     *     jsonrpc: '2.0',
     *     id: string|number,
     *     result: array<string, mixed>|\WP\McpSchema\V20260728\Common\Protocol\DTO\DiscoverResult
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\V20260728\Common\Protocol\DTO\DiscoverResult $result */
        $result = is_array($data['result'])
            ? DiscoverResult::fromArray(self::asArray($data['result']))
            : $data['result'];
    ...
    /**
     * @return \WP\McpSchema\V20260728\Common\Protocol\DTO\DiscoverResult
     */
    public function getTypedResult(): DiscoverResult
    {

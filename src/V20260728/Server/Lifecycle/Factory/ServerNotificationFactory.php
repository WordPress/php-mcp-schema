...
namespace WP\McpSchema\V20260728\Server\Lifecycle\Factory;

use WP\McpSchema\V20260728\Server\Lifecycle\Union\ServerNotificationInterface;
use WP\McpSchema\V20260728\Common\Protocol\DTO\CancelledNotification;
use WP\McpSchema\V20260728\Common\Protocol\DTO\ProgressNotification;
use WP\McpSchema\V20260728\Server\Logging\DTO\LoggingMessageNotification;
use WP\McpSchema\V20260728\Server\Resources\DTO\ResourceUpdatedNotification;
use WP\McpSchema\V20260728\Server\Resources\DTO\ResourceListChangedNotification;
use WP\McpSchema\V20260728\Server\Tools\DTO\ToolListChangedNotification;
use WP\McpSchema\V20260728\Server\Prompts\DTO\PromptListChangedNotification;
use WP\McpSchema\V20260728\Common\Protocol\DTO\SubscriptionsAcknowledgedNotification;
...
final class ServerNotificationFactory
{
    ...
    public const REGISTRY = [
        ...
        'notifications/subscriptions/acknowledged' => SubscriptionsAcknowledgedNotification::class,
    ];

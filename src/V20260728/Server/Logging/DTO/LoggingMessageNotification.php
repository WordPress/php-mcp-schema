...
class LoggingMessageNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    /**
     * @var \WP\McpSchema\V20260728\Server\Logging\DTO\LoggingMessageNotificationParams
     */
    protected LoggingMessageNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \WP\McpSchema\V20260728\Server\Logging\DTO\LoggingMessageNotificationParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\V20260728\Server\Logging\DTO\LoggingMessageNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\V20260728\Server\Logging\DTO\LoggingMessageNotificationParams $params */
    ...
    /**
     * @return \WP\McpSchema\V20260728\Server\Logging\DTO\LoggingMessageNotificationParams
     */

...
class ListResourcesResult extends PaginatedResult implements ServerResultInterface
{
     ...
     */
    private const KNOWN_KEYS = ['nextCursor', '_meta', 'resultType', 'resources', 'ttlMs', 'cacheScope'];

    /**
     * @since 2024-11-05
     *
     * @var array<\WP\McpSchema\V20260728\Server\Resources\DTO\Resource>
     */
     ...
     * @param array<\WP\McpSchema\V20260728\Server\Resources\DTO\Resource> $resources @since 2024-11-05
     ...
     *     resources: array<array<string, mixed>|\WP\McpSchema\V20260728\Server\Resources\DTO\Resource>,
     *     ttlMs: float,
    ...
    {
        self::assertRequired($data, ['resultType', 'resources', 'ttlMs', 'cacheScope']);

        /** @var "complete"|"input_required"|string $resultType */
        $resultType = $data['resultType'];

        /** @var array<\WP\McpSchema\V20260728\Server\Resources\DTO\Resource> $resources */
        $resources = array_map(
    ...
    /**
     * @return array<\WP\McpSchema\V20260728\Server\Resources\DTO\Resource>
     */
